                  ...
                  <div className="p-4">
                    ...
                    {clip.download_url && (
                      <a
                        ...
                        download
                        className="inline-flex w-full items-center justify-center rounded-lg bg-neutral-800 px-3 py-2 text-sm font-semibold text-neutral-100 hover:bg-neutral-700"
                      >
                        Download
                      </a>
                    )}
